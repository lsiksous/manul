...
3. Customize environment variables:
   ...
   You should have obtain a passport from HPE. It is mandatory that you include
   it here.
...
6. Generate hosts file:
   ...
   10.0.1.3 node01.manul.arpa
   10.0.1.4 node02.manul.arpa
   10.0.1.5 node03.manul.arpa
   10.0.1.2 edge.manul.arpa
   #+end_example
