...
- [[#introduction][Introduction]]
  - [[#project-overview][Project Overview]]
    ...
    - [[#use-camelcase-snake_case-or-kebab-case][Use CamelCase, snakecase, or kebab-case]]
    - [[#include-version-numbers-or-dates-if-applicable][Include Version Numbers or Dates (if applicable)]]
    - [[#avoid-special-characters][Avoid Special Characters]]
    - [[#use-file-extensions-appropriately][Use File Extensions Appropriately]]
...
** Project Overview
   ...
   [[https://www.youtube.com/watch?v=v4oYOjVDgo0][Jean Piaget's cognitive stages of development]]
